...
/**
 * A base trait for an isolation tree.
 * Both "standard" and "extended" trees can extend this trait
...
private[isolationforest] trait IsolationTreeBase extends Serializable {
   ...
   *
   * :param dataPoint: The data point for which to calculate the path length.
   * :return: The path length for the data point.
   */
